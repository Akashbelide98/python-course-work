...
# Example: {"Name": "Jiomart Warehouse 4", "Contact": 9876543210, "Location": "Delhi"}
...
print("Warehouse Details: Name - {}, Contact - {}, Location - {}".format(Warehouse_Details["Name"], Warehouse_Details["Contact"], Warehouse_Details["Location"]))

print("Thank you for shopping at JIOMART",)
